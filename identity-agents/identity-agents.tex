...
The Private Data Network (PDN) is a set of protocols designed to support data sharing between MDN nodes. These nodes may be integrated with a provider's apps or websites, and/or within the user's identity agent if they choose to install and configure one or more of them on their devices.
