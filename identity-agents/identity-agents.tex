...
Figure~\ref{fig:functionality} summarizes the functionality of an agent.  The first set of rows list the set basic identity agent functions.  The cells in light and dark green show the progress of implementation work being led by The Mee Foundation. The second set of rows list potential identity provider protocols that the agents may implement.
...
An agent also acts as an identity provider and may implement open protocols such as:
