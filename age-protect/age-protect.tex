...
\subsection{AVR issuance and presentation notes}

To maximize privacy we leverage \hyperfootnote[selective disclosure][https://]{w3.org/TR/vc-imp-guide/\#selective-disclosure}. 

The expiration date will never be presented to the verifier.

The \emph{jurisdiction} and/or \emph{ageVerificationMethod} are only presented to the verifier if requested. 
