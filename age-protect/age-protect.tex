...
\begin{itemize}
	...
	\item \textbf{Standards-based}. To simplify adoption and implementation the fundamentals of Age Protect are based as much as is possible on existing open technical standards.
\end{itemize}
