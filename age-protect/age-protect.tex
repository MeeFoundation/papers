...
\begin{enumerate}
	...
	\item Their smartwallet's browser extension attempts to fetch from their smartwallet an authorization token (issued by an AVS) that specifies that the minor is permitted to visit Facebook.com. In this scenario no such token exists.
