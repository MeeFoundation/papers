...
An Age Protect-compatible wallet relies on a browser extension that implements the \hyperfootnote[Provider Discovery][https://]{providerdiscovery.org} protocol. Using this protocol the browser extension includes the \emph{Provider} HTTP header field with a value of \emph{"AgeProtectv1"}:
...
\begin{lstlisting}[language=json,firstnumber=1]
	"Provider: AgeProtectv1, https://privo.com/age-protect.pcf"
\end{lstlisting}
